...
public class Ligne_Facture_Client {
	...
	public Ligne_Facture_Client(String réf, String désignation, String unité_mésure, int qté_livrée, float pU_hors_TVA,
			float tVA_appliquée, float p_total_horsTVA) {
		super();
		this.réf = réf;
		this.désignation = désignation;
		this.unité_mésure = unité_mésure;
		this.qté_livrée = qté_livrée;
