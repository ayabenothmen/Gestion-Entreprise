...
public class Ligne_Facture_Fournisseur {
	
	String réf;
    String désignation;
    String unité_mésure;
    int qté_réceptionnée;
    float PU_hors_TVA;
    float TVA_appliquée;
    float P_total_horsTVA;
	public Ligne_Facture_Fournisseur() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Ligne_Facture_Fournisseur(String réf, String désignation, String unité_mésure, int qté_réceptionnée,
			float pU_hors_TVA, float tVA_appliquée, float p_total_horsTVA) {
		super();
		this.réf = réf;
		this.désignation = désignation;
		this.unité_mésure = unité_mésure;
		this.qté_réceptionnée = qté_réceptionnée;
	...
	public int getQté_réceptionnée() {
		return qté_réceptionnée;
	}
	public void setQté_réceptionnée(int qté_réceptionnée) {
		this.qté_réceptionnée = qté_réceptionnée;
	}
